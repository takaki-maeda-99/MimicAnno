#!/usr/bin/env bash
# GEM4 pick_up_bottle — 26B QLoRA アダプタで推論
# Usage:
#   GPU=0 bash scripts/run_26B_gem4_pick_up_bottle.sh
...
LOGS_DIR="${LOGS_DIR:-$REPO/logs/batch_gem4_pick_up_bottle_26B}"
...
echo "[gpu=$GPU] GEM4 pick_up_bottle 26B  episodes $START..$END"
cd "$REPO"
