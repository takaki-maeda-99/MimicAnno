#!/usr/bin/env bash
# SO101 — 26B QLoRA アダプタで推論
# Usage:
#   GPU=0 bash scripts/run_26B_so101.sh
#   GPU=0 START=0 END=17 bash scripts/run_26B_so101.sh &
#   GPU=1 START=18 END=35 bash scripts/run_26B_so101.sh
...
echo "[gpu=$GPU] SO101 26B  episodes $START..$END"
cd "$REPO"
